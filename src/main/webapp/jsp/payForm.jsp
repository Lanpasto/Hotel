            ...
            <div class=" h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5"
                ...
                <form method="post" action="controller?action=payment" class="register-form">
                    <div class="card">
                        ...
                        <div class="card-details"><input name="card" type="text" placeholder="1111-2222-3333-4444"
                                                         data-slots="0" data-accept="\d" size="19">
                            <span>Card Number</span> <i class="fa fa-credit-card"></i></div>
                        <div class="exp-cvv">
                            <div class="card-details"><input name="yearAndMonth" type="text" placeholder="mm/yyyy"
                                                             data-slots="my"> <span>Expiry date</span> <i
                                    class="fa fa-calendar"></i></div>
                            <div class="card-details"><input name="cvv" type="text" placeholder="000" data-slots="0"
                                                             data-accept="\d" size="3"> <span>CVV</span> <i
                                    class="fa fa-info-circle"></i></div>
                        </div>
                        <div style="margin-bottom: 20px" class="card-details mt-25"><input name="name" type="text"
                                                                                           placeholder="Poncho Rider">
                            <span>Card Holder Name</span></div>
                    ...
                    <p style="font-size: 16px;font-style: italic;color: red;  text-align: center;"
